...
lint:
	ruff check src/ospedit/data.py src/ospedit/adapters.py src/ospedit/external_baselines.py src/ospedit/foldflow_batch.py src/ospedit/foldflow_env.py src/ospedit/models.py src/ospedit/experiment.py src/ospedit/manifest_cli.py src/ospedit/split_cli.py src/ospedit/p1_preflight.py src/ospedit/teacher_evaluation.py scripts/run_mechanism_grid.py scripts/run_mechanism_sweep.py scripts/select_mechanism_config.py scripts/run_teacher_admission.py scripts/build_teacher_cache.py scripts/evaluate_teacher_cache.py scripts/evaluate_teacher_combinations.py scripts/audit_microminer_metadata.py scripts/build_microminer_manifest.py scripts/build_premut_manifest.py scripts/build_platinum_manifest.py scripts/discover_rcsb_repeats.py scripts/select_microminer_candidates.py scripts/select_premut_repeat_candidates.py scripts/merge_manifests.py scripts/audit_response_scale.py scripts/audit_repeat_structures.py scripts/audit_structure_context.py scripts/run_student_bound_sweep.py scripts/run_premut_baseline.py scripts/run_esmfold_baseline.py scripts/assemble_benchmark_table.py scripts/assemble_runtime_table.py examples/foldflow_endpoint_factory.py examples/premut_predict.py examples/premut_batch_predict.py examples/esmfold_predict.py

typecheck:
	mypy src/ospedit/data.py src/ospedit/foldflow_env.py src/ospedit/foldflow_batch.py src/ospedit/adapters.py src/ospedit/external_baselines.py src/ospedit/models.py src/ospedit/experiment.py src/ospedit/manifest_cli.py src/ospedit/split_cli.py src/ospedit/p1_preflight.py src/ospedit/teacher_cache.py src/ospedit/teacher_evaluation.py src/ospedit/student_data.py src/ospedit/student_training.py src/ospedit/train_cli.py scripts/run_student_bound_sweep.py scripts/run_mechanism_sweep.py scripts/select_mechanism_config.py scripts/evaluate_teacher_cache.py scripts/evaluate_teacher_combinations.py scripts/audit_response_scale.py scripts/audit_repeat_structures.py scripts/audit_structure_context.py scripts/audit_microminer_metadata.py scripts/build_microminer_manifest.py scripts/build_premut_manifest.py scripts/build_platinum_manifest.py scripts/discover_rcsb_repeats.py scripts/select_microminer_candidates.py scripts/select_premut_repeat_candidates.py scripts/merge_manifests.py scripts/run_premut_baseline.py scripts/run_esmfold_baseline.py scripts/assemble_benchmark_table.py scripts/assemble_runtime_table.py --ignore-missing-imports
